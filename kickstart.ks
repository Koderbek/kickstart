...
# Create User Account
user --name=yuriy --password=1234 --groups=wheel
...
sudo curl -o /usr/bin/containers.sh https://raw.githubusercontent.com/Koderbek/kickstart/master/containers.sh
sudo chmod +x /usr/bin/containers.sh
sudo curl -o /etc/systemd/system/containers.service https://raw.githubusercontent.com/Koderbek/kickstart/master/containers.service
